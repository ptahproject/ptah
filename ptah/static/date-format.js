 ...
 */
define(
    'ptah-date-format', ['jquery', 'handlebars'],
    ...
    function($, handlebars) {
        ...
        var dateFormat = function () {
            ...
            return function (date, mask, utc) {
                ...
                // You can't provide utc if you skip other args
                // (use the "UTC:" mask prefix)
        ...
        // format
        if (typeof(ptah_dt) === 'undefined') {
            var ptah_dt = {'short': 'm/d/yy h:MM TT',
        ...
        handlebars.registerHelper(
            'dateTime', function(text, format) {
                ...
                format = ptah_dt[format]
                if (!format)
                    format = ptah_dt['short']
